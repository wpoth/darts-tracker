...
export default function SelectFriendMatchScreen() {
    ...
    async function loadData() {
        ...
        if (profileResult.error || !profileResult.profile) {
            Alert.alert(
                "Profile missing",
                "You need to be logged in and have a username first."
            );
            setIsLoading(false);
            return;
        }
    ...
    function startLocalMatch(friend: FriendProfile) {
        router.push({
            pathname: "/x01",
            params: {
                title,
                startingScore: String(startingScore),
                doubleIn,
                doubleOut: String(doubleOut),
        ...
        <SafeAreaView style={styles.safeArea}>
            ...
            >
                <View style={styles.header}>
                    ...
                    <Text style={styles.eyebrow}>One phone match</Text>
                    <Text style={styles.title}>{title}</Text>
                    <Text style={styles.subtitle}>
                        Choose a friend to add as Player 2 on this phone. No invite will be
                        sent.
                    </Text>
                </View>
                ...
                <View style={styles.section}>
                    ...
                    {isLoading ? (
                        ...
                        <Text style={styles.emptyText}>
                            You need to add a friend before you can add them to a match.
                        </Text>
                    ) : (
                                ...
                                <View key={friend.id} style={styles.friendRow}>
                                    <View style={styles.friendText}>
                                        ...
                                        <Text style={styles.friendSubText}>
                                            Add as Player 2 locally
                                        </Text>
                                    </View>

                                    <Pressable
                                        style={styles.playButton}
                                        onPress={() => startLocalMatch(friend)}
                                    >
